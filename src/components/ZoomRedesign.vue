    ...
    data() {
      return {
        ...
        motivateInfos: [{
          id: 0,
          title: 'Prompt',
          sentence: 'Online meeting becomes popular since the rise of remote teaching. Zoom, which is one of the largest online meeting software used by online courses.'
        }, {
          id: 1,
          title: 'Problem',
          sentence: 'The usability of Zoom could be improved to meet the demand of online courses. '
        }, {
          id: 2,
          title: 'Solution',
          sentence: '???'
